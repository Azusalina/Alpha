...
- contour.json polylines, projected with contract 3, lie on the silhouette boundary of the mask.
- docs/HAND_ASSETS.md rebuild instructions actually work as written.
Set passed=true only if everything holds with evidence you produced.`,
  },
  {
    key: 'tauri',
